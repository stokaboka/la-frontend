    ...
    <div class="wrapper">
      ...
      <div v-if="!isLogged" class="column q-mt-md text-grey-14">
        ...
        <div class="q-mt-lg text-grey-14">
          <p>Вы можете пройти первую (самостоятельную) часть теста анонимно. По окончании теста будет определен ваш ориентировочный уровень по методикам <a :href="links.cef" target="_blank"><q>CEF</q></a> и <a :href="links.svs" target="_blank"><q>Свобода слова</q></a></p>
